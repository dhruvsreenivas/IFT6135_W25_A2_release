...
from data import get_arithmetic_dataset, get_arithmetic_dataset_multiple_orders
from gpt import GPT
...
def train(args):
    ...
    if args.q4_modified:
        ...
        (train_dataset, valid_dataset), tokenizer, MAX_LENGTH, padding_index = (
            get_arithmetic_dataset_multiple_orders(
                args.p,
                args.p,
                args.operator,
                args.r_train,
...
if __name__ == "__main__":
    ...
    all_models_per_trials, all_metrics, all_checkpoint_paths = train_m_models(
        args, M=2, seeds=None
    )
    print("==" * 60)
